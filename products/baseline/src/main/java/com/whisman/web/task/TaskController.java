...
import com.whisman.modules.web.Servlets;
import com.whisman.biz.task.entity.Task;
import com.whisman.biz.task.service.TaskService;
...
public class TaskController {
    ...
    @ResponseBody
    public DataTable<Task> searchPage(DataTablePageable pageable){
        DataTablePage<Task> page = new DataTablePage<Task>(taskService.getUserTask(pageable));
