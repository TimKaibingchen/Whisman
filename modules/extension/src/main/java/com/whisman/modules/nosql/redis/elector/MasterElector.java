 ...
 *----------------------------------------------------------------------------*/
package com.whisman.modules.nosql.redis.elector;
...
import com.whisman.modules.nosql.redis.JedisTemplate;
import com.whisman.modules.utils.Threads;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.whisman.modules.utils.Threads.WrapExceptionRunnable;
...
public class MasterElector implements Runnable {
	...
	@Override
	public void run() {
		jedisTemplate.execute(new JedisTemplate.JedisActionNoResult() {// NOSONAR
					@Override
