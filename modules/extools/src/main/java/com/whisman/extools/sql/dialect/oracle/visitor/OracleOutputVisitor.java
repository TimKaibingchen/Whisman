...
import com.whisman.extools.sql.ast.expr.SQLLiteralExpr;
...
import com.whisman.extools.sql.ast.statement.SQLJoinTableSource.JoinType;
...
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import com.whisman.extools.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
...
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
...
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
...
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleMergeStatement.MergeInsertClause;
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleMergeStatement.MergeUpdateClause;
...
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
...
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
...
public class OracleOutputVisitor extends SQLASTOutputVisitor implements OracleASTVisitor {
    ...
    @Override
    public void endVisit(com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(com.whisman.extools.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print("WHEN ");
        x.getWhen().accept(this);
        incrementIndent();
