 ...
 */
package com.whisman.extools.stat;
...
public class TableStat {
    ...
    public static class Name {
        ...
        public int hashCode() {
            return lowerHashCode(name);
        }

        private int lowerHashCode(String text) {
            int h = 0;
    ...
    public static class Column {
        ...
        public int hashCode() {
            int tableHashCode = table != null ? lowerHashCode(table) : 0;
            int nameHashCode = name != null ? lowerHashCode(name) : 0;
